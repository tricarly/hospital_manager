...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td><textarea name="descs" style="width: 440px;height: 180px"></textarea></td>
    </tr>
    ...
    <tr>
        ...
        <td><textarea name="description" style="width: 440px;height: 180px"></textarea></td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">生产厂商</td>
        <td><input type="text" name="producefirm" value=""/></td>
    </tr>
    <tr>
	...
	<tr>
        ...
        <td><textarea name="remark" style="width: 440px;height: 180px"></textarea></td>
	</tr>
    <tr>
        <td colspan="2">
			<center>
