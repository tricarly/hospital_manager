...
<body>
<form action="${pageContext.request.contextPath}/medicine/update" method="post" class="definewidth m20" enctype="multipart/form-data">
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <img  width="80px" height="50px" src="/upload/hospital/${medicine.picture}">
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
        	<input type="radio" name="type" value="1" <c:if test="${medicine.type==1}">checked</c:if>/>处方药&nbsp;&nbsp;&nbsp;
        	<input type="radio" name="type" value="2" <c:if test="${medicine.type==2}">checked</c:if>/>中药&nbsp;&nbsp;&nbsp;
        	<input type="radio" name="type" value="3" <c:if test="${medicine.type==3}">checked</c:if>/>西药
        </td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">简单描述</td>
        <td><textarea name="descs" style="width: 440px;height: 180px">${medicine.descs}</textarea></td>
    </tr>
    ...
    <tr>
        ...
        <td><textarea name="description" style="width: 440px;height: 180px">${medicine.description}</textarea></td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">生产厂商</td>
        <td><input type="text" name="producefirm" value="${medicine.producefirm}"></td>
    </tr>
    <tr>
	...
	<tr>
        ...
        <td><textarea name="remark" style="width: 440px;height: 180px">${medicine.remark}</textarea></td>
	</tr>
    <tr>
        <td colspan="2">
			<center>
